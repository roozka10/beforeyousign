      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-4xl">
        <nav className="flex items-center justify-between gap-4 px-3 py-2 rounded-2xl border border-border bg-card/80 backdrop-blur-xl shadow-elevated">
          <Link to="/" className="flex items-center gap-2 pl-2">
            <img src="/ChatGPT_Image_Apr_26__2026__09_24_37_AM-removebg-preview.png" alt="beforeyousign" className="w-7 h-7 object-contain" />
      ...
      <footer className="px-6 py-10 border-t border-border">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            <img src="/ChatGPT_Image_Apr_26__2026__09_24_37_AM-removebg-preview.png" alt="beforeyousign" className="w-6 h-6 object-contain" />
